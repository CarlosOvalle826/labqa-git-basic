...
Este es un proyecto de pruebas para practicar comandos de Git.

## Objetivo

El propósito principal de este repositorio es servir como entorno de aprendizaje para el uso de ramas, merges y resolución de conflictos en Git.

## Práctica de conflicto de merge

Las ramas necesarias para la práctica ya están creadas:
- `feature/A`
- `feature/B`
...
¡Este repositorio es ideal para aprender Git haciendo!
